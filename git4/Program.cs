...
namespace git4
{
    class Program
    {
        ...
        static void StudentChoice(int[] arr)
        {
            ...
            do
            {
                Console.WriteLine("Якщо ви хочете виконати варiант 6 студентки Позднякової А.Д введiть 1");
                Console.WriteLine("Якщо ви хочете виконати варiант 10 студента Лося К. введiть 2");
                Console.WriteLine("Щоб вивести поточний стан масиву введiть 3");
                Console.WriteLine("Щоб перестворити масив заново введiть 4");
